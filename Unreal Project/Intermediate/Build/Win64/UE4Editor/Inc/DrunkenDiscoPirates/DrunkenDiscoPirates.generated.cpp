...
FName DRUNKENDISCOPIRATES_MoveDownUI = FName(TEXT("MoveDownUI"));
FName DRUNKENDISCOPIRATES_MoveUpUI = FName(TEXT("MoveUpUI"));
FName DRUNKENDISCOPIRATES_OnSelectUI = FName(TEXT("OnSelectUI"));
FName DRUNKENDISCOPIRATES_SetFlipbooks = FName(TEXT("SetFlipbooks"));
FName DRUNKENDISCOPIRATES_TogglePause = FName(TEXT("TogglePause"));
	void UAnimatedImage::StaticRegisterNativesUAnimatedImage()
	{
		FNativeFunctionRegistrar::RegisterFunction(UAnimatedImage::StaticClass(), "Play",(Native)&UAnimatedImage::execPlay);
		FNativeFunctionRegistrar::RegisterFunction(UAnimatedImage::StaticClass(), "Stop",(Native)&UAnimatedImage::execStop);
	}
	IMPLEMENT_CLASS(UAnimatedImage, 4002065846);
	...
	void ACamera::MoveDownUI(int32 playerIndex)
	{
		Camera_eventMoveDownUI_Parms Parms;
		Parms.playerIndex=playerIndex;
		ProcessEvent(FindFunctionChecked(DRUNKENDISCOPIRATES_MoveDownUI),&Parms);
	}
	void ACamera::MoveUpUI(int32 playerIndex)
	{
		Camera_eventMoveUpUI_Parms Parms;
		Parms.playerIndex=playerIndex;
		ProcessEvent(FindFunctionChecked(DRUNKENDISCOPIRATES_MoveUpUI),&Parms);
	}
	void ACamera::OnSelectUI(int32 playerIndex)
	{
		Camera_eventOnSelectUI_Parms Parms;
		Parms.playerIndex=playerIndex;
		ProcessEvent(FindFunctionChecked(DRUNKENDISCOPIRATES_OnSelectUI),&Parms);
	}
	void ACamera::TogglePause(int32 playerIndex)
	{
		Camera_eventTogglePause_Parms Parms;
		Parms.playerIndex=playerIndex;
		ProcessEvent(FindFunctionChecked(DRUNKENDISCOPIRATES_TogglePause),&Parms);
	}
	void ACamera::StaticRegisterNativesACamera()
	{
	}
	IMPLEMENT_CLASS(ACamera, 1849073781);
...
// Cross Module References
	...
	DRUNKENDISCOPIRATES_API class UFunction* Z_Construct_UFunction_UAnimatedImage_Play();
	DRUNKENDISCOPIRATES_API class UFunction* Z_Construct_UFunction_UAnimatedImage_Stop();
	DRUNKENDISCOPIRATES_API class UClass* Z_Construct_UClass_UAnimatedImage_NoRegister();
	DRUNKENDISCOPIRATES_API class UClass* Z_Construct_UClass_UAnimatedImage();
	DRUNKENDISCOPIRATES_API class UFunction* Z_Construct_UFunction_ACamera_FillRumMeter();
	DRUNKENDISCOPIRATES_API class UFunction* Z_Construct_UFunction_ACamera_MoveDownUI();
	DRUNKENDISCOPIRATES_API class UFunction* Z_Construct_UFunction_ACamera_MoveUpUI();
	DRUNKENDISCOPIRATES_API class UFunction* Z_Construct_UFunction_ACamera_OnSelectUI();
	DRUNKENDISCOPIRATES_API class UFunction* Z_Construct_UFunction_ACamera_TogglePause();
	...
	UFunction* Z_Construct_UFunction_UAnimatedImage_Play()
	{
		UObject* Outer=Z_Construct_UClass_UAnimatedImage();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("Play"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04080401, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Animation"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("AnimatedImage.h"));
#endif
		}
		return ReturnFunction;
	}
	UFunction* Z_Construct_UFunction_UAnimatedImage_Stop()
	{
		UObject* Outer=Z_Construct_UClass_UAnimatedImage();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("Stop"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04080401, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_UAnimatedImage_NoRegister()
	{
		return UAnimatedImage::StaticClass();
	}
	UClass* Z_Construct_UClass_UAnimatedImage()
	{
		...
		if (!OuterClass)
		{
			...
			OuterClass = UAnimatedImage::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				UObjectForceRegistration(OuterClass);
				OuterClass->ClassFlags |= 0x20900080;

				OuterClass->LinkChild(Z_Construct_UFunction_UAnimatedImage_Play());
				OuterClass->LinkChild(Z_Construct_UFunction_UAnimatedImage_Stop());

PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_loopEnd = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("loopEnd"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(loopEnd, UAnimatedImage), 0x0020080000000005);
				UProperty* NewProp_loopStart = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("loopStart"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(loopStart, UAnimatedImage), 0x0020080000000005);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(shouldLoop, UAnimatedImage, bool);
				UProperty* NewProp_shouldLoop = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("shouldLoop"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(shouldLoop, UAnimatedImage), 0x0020080000000005, CPP_BOOL_PROPERTY_BITMASK(shouldLoop, UAnimatedImage), sizeof(bool), true);
				UProperty* NewProp_framesPerSecond = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("framesPerSecond"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(framesPerSecond, UAnimatedImage), 0x0020080000000005);
				UProperty* NewProp_images = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("images"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(images, UAnimatedImage), 0x0020080000000005);
				UProperty* NewProp_images_Inner = new(EC_InternalUseOnlyConstructor, NewProp_images, TEXT("images"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UClass_UTexture2D_NoRegister());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAnimatedImage_Play(), "Play"); // 3833662409
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAnimatedImage_Stop(), "Stop"); // 3884694314
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				MetaData->SetValue(OuterClass, TEXT("IncludePath"), TEXT("AnimatedImage.h"));
				MetaData->SetValue(OuterClass, TEXT("ModuleRelativePath"), TEXT("AnimatedImage.h"));
				MetaData->SetValue(NewProp_loopEnd, TEXT("Category"), TEXT("Animation"));
				MetaData->SetValue(NewProp_loopEnd, TEXT("ModuleRelativePath"), TEXT("AnimatedImage.h"));
				MetaData->SetValue(NewProp_loopStart, TEXT("Category"), TEXT("Animation"));
				MetaData->SetValue(NewProp_loopStart, TEXT("ModuleRelativePath"), TEXT("AnimatedImage.h"));
				MetaData->SetValue(NewProp_shouldLoop, TEXT("Category"), TEXT("Animation"));
				MetaData->SetValue(NewProp_shouldLoop, TEXT("ModuleRelativePath"), TEXT("AnimatedImage.h"));
				MetaData->SetValue(NewProp_framesPerSecond, TEXT("Category"), TEXT("Animation"));
				MetaData->SetValue(NewProp_framesPerSecond, TEXT("ModuleRelativePath"), TEXT("AnimatedImage.h"));
				MetaData->SetValue(NewProp_images, TEXT("Category"), TEXT("Animation"));
				MetaData->SetValue(NewProp_images, TEXT("ModuleRelativePath"), TEXT("AnimatedImage.h"));
#endif
			}
		}
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAnimatedImage(Z_Construct_UClass_UAnimatedImage, &UAnimatedImage::StaticClass, TEXT("UAnimatedImage"), false, nullptr, nullptr, nullptr);
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAnimatedImage);
	...
	UFunction* Z_Construct_UFunction_ACamera_MoveDownUI()
	{
		UObject* Outer=Z_Construct_UClass_ACamera();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("MoveDownUI"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x08020800, 65535, sizeof(Camera_eventMoveDownUI_Parms));
			UProperty* NewProp_playerIndex = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("playerIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(playerIndex, Camera_eventMoveDownUI_Parms), 0x0010000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Code"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Camera.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Move down UI."));
#endif
		}
		return ReturnFunction;
	}
	UFunction* Z_Construct_UFunction_ACamera_MoveUpUI()
	{
		UObject* Outer=Z_Construct_UClass_ACamera();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("MoveUpUI"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x08020800, 65535, sizeof(Camera_eventMoveUpUI_Parms));
			UProperty* NewProp_playerIndex = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("playerIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(playerIndex, Camera_eventMoveUpUI_Parms), 0x0010000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Code"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Camera.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Move up UI."));
#endif
		}
		return ReturnFunction;
	}
	UFunction* Z_Construct_UFunction_ACamera_OnSelectUI()
	{
		UObject* Outer=Z_Construct_UClass_ACamera();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("OnSelectUI"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x08020800, 65535, sizeof(Camera_eventOnSelectUI_Parms));
			UProperty* NewProp_playerIndex = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("playerIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(playerIndex, Camera_eventOnSelectUI_Parms), 0x0010000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Code"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Camera.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("On select UI."));
#endif
		}
		return ReturnFunction;
	}
	UFunction* Z_Construct_UFunction_ACamera_TogglePause()
	{
		UObject* Outer=Z_Construct_UClass_ACamera();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("TogglePause"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x08020800, 65535, sizeof(Camera_eventTogglePause_Parms));
			UProperty* NewProp_playerIndex = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("playerIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(playerIndex, Camera_eventTogglePause_Parms), 0x0010000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Code"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Camera.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("On pause."));
#endif
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_ACamera()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->LinkChild(Z_Construct_UFunction_ACamera_MoveDownUI());
				OuterClass->LinkChild(Z_Construct_UFunction_ACamera_MoveUpUI());
				OuterClass->LinkChild(Z_Construct_UFunction_ACamera_OnSelectUI());
				OuterClass->LinkChild(Z_Construct_UFunction_ACamera_TogglePause());
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				...
				UProperty* NewProp_currentlyPausedPlayerIndex = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("currentlyPausedPlayerIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(currentlyPausedPlayerIndex, ACamera), 0x0020080000000005);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(isPaused, ACamera, bool);
				UProperty* NewProp_isPaused = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("isPaused"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(isPaused, ACamera), 0x0020080000000005, CPP_BOOL_PROPERTY_BITMASK(isPaused, ACamera), sizeof(bool), true);
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ACamera_FillRumMeter(), "FillRumMeter"); // 2563861584
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ACamera_MoveDownUI(), "MoveDownUI"); // 106519296
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ACamera_MoveUpUI(), "MoveUpUI"); // 415922970
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ACamera_OnSelectUI(), "OnSelectUI"); // 2769508417
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ACamera_TogglePause(), "TogglePause"); // 2725036156
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				...
				MetaData->SetValue(NewProp_currentlyPausedPlayerIndex, TEXT("Category"), TEXT("Code"));
				MetaData->SetValue(NewProp_currentlyPausedPlayerIndex, TEXT("ModuleRelativePath"), TEXT("Camera.h"));
				MetaData->SetValue(NewProp_currentlyPausedPlayerIndex, TEXT("ToolTip"), TEXT("The index of the player that has currently paused the game."));
				MetaData->SetValue(NewProp_isPaused, TEXT("Category"), TEXT("Code"));
				MetaData->SetValue(NewProp_isPaused, TEXT("ModuleRelativePath"), TEXT("Camera.h"));
				MetaData->SetValue(NewProp_isPaused, TEXT("ToolTip"), TEXT("Defines whether or not the game is paused."));
#endif
			}
		}
		check(OuterClass->GetClass());
